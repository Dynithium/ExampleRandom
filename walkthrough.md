# Minslaire — Walkthrough

> **Note:** This document is a scene-by-scene, in-the-moment walkthrough of the game as we design it, written in the player's voice. It walks hand-in-hand with [story.md](story.md), [gameplay.md](gameplay.md), and [locations.md](locations.md).
...
The screen is black, then there's sound: a low, steady hum. Your life suit, warming to you before you even open your eyes. It's been there your whole life, like breathing.

You wake and yawn. Living in the village is pretty simple. You grow the crops, raise the livestock, mend the fences. There's enough for everything. It's been that way as long as anyone can remember.

Across the room, a second bed — a small shape under the blanket. Your brother, Tinslaire, still asleep. Above the door: your father's blade, in its glass case. It's the only thing left of him.

And as your feet touch the floor, his words come back — the last time he ever taught you.

### Scene 1.5: The Memory (cutscene as you get out of bed)

*The room fades. You're small again, standing in the yard. Your father stands over you, the blade in his hands, moving slow so you can follow.*

> **Father:** "Everything and everyone has a purpose, which reflects their maker."
>
> *He holds the blade up, flat in his palm.*
>
> **Father:** "Like this blade. It was made by me. It's designed for fighting — that's what it's for. But look."
>
> *He slides it into its sheath. Click.*
>
> **Father:** "It has a sheath. And that sheath is made to show that it is **not time for battle.**"
>
> *He kneels, so he's eye to eye with you.*
>
> **Father:** "I fear that one day, calamities might befall you. And it might just be... time for war."
>
...
Tinslaire's eyes are wide as you walk in. He's not scared — he's *giddy*.

*"Minslaire! The elders are at the door. The actual elders! They came to *our* house!"*

You open the door. Three of them stand on your doorstep like it's the most ordinary thing in the world: Elder Moss, Elder Sage, and Elder Thorn, in their plain wool robes. Elder Moss speaks first, calm and unhurried.

> **Elder Moss:** "Good morning, Minslaire. I'm sorry for the early visit. We heard sounds from the cave — the old one, just on the outskirts of town, where the forest begins. Something's stirring in there that shouldn't be."
>
...
Before they hand you a sword, the elders want to know what kind of person they're sending into that cave. Each one gives you a small task — and each is a test you don't know you're taking.
...
- **The Night Watch (Elder Thorn, trial 5).** Read the roster in the Plaza Watchhouse first — it says WEST, then EAST, then CENTRE, and it says so specifically because *"any fool lights left to right."* Light them in that order on the north rampart. Get it wrong and the whole line snuffs itself out and you start again. When you report back, Thorn tells you what the line is actually for: *"It isn't to warn you. It's to warn us — about whatever is coming back down that road."*
- **The Dry Cistern (Elder Sage, trial 6).** The aqueduct runs full and the cistern is empty. Three sluice gates, each SHUT / HALF / OPEN. The rule is written, not shown: the head gate feeds, the middle must hold or the water is lost to the pond, the last is throttled or the channel overtops. Head OPEN, middle SHUT, last HALF. Sage's compliment afterwards is not really a compliment: *"Where you are going, improvising will kill you."*
- **The Blighted Rows (the Orchard Keeper, trial 7).** Three rows on the western terrace. Put your hand in the soil of each. Two are cool and alive. The middle one is *warm* — warm from below — and your fingers come up smelling of hot metal and oil. That is not a blight. The Keeper makes a sign over his chest you have never seen anyone make, and tells you to say nothing to anyone.
- **The Short Tally (Elder Moss, trial 8).** The granary board reads 160. The four sacks weigh 110. Fifty short — the same fifty the trader miscounted at the Bazaar, which is not a coincidence the game will explain to you. Moss pauses exactly one beat too long, calls it the winter reserve, says he authorised it himself, and tells you not to trouble yourself with the granary again.
- **The Muster (Elder Thorn, trial 9).** A real drill in Founders' Plaza, with Thorn moving to the plaza to run it. He calls GUARD, DODGE, STRIKE and you answer with R, SHIFT and SPACE. Afterwards: *"Your father drilled exactly like that. Same hitch before the riposte."* And then the actual warning — *"Everything after today, you do slower than they tell you to."*
- **The Scrap in the Quarry (Elder Sage, trial 10).** The quarry face collapsed in the night and three constructs came out of it. This is your first fight against machines, before the cave and before you have your father's blade. Behind them is a smooth-walled shaft nobody in Elderville dug. Sage takes the fragment you bring and asks not one question about the shaft.

When the ten tasks are done, the elders confer in low voices behind the Blue House door. Whatever they decide, they come out with a nod.

### Scene 3: The Elders' Test (tutorial)

Before they let you leave for the cave, Elder Thorn raises a hand. Now he tests your blade.

> **Elder Thorn:** "Not so fast. If you're going into that cave with a blade, I want to see you use it. Humor an old man."

The three of them lead you to the clearing behind the Blue House, where the training dummies stand. What follows is a proper trial:

- **Sword test — with Elder Thorn.** He walks you through the basics, slow and patient: the slash, the stance, the rhythm of an attack. *"Good. Again. Don't swing to hurt — swing like it means something."* You cut down a row of training dummies. (Tutorial: attack, facing, cooldown.)
- **Bow test — with Elder Sage.** He hands you a bow. *"The blade is for when they get close. This is for when they don't."* Targets in the field, one after another — some still, some moving. (Tutorial: bow, aim, range.)
- **Dodge and block — with Elder Thorn again.** He feints at you with a padded staff. *"Block. Roll. Block again. Your suit will carry you, but only if you don't ask it to do everything."* (Tutorial: dodge, block, stamina.)
