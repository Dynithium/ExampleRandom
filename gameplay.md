...
| 3 | Talk to Elder Sage | Elder Sage has studied the old records. She waits near the garden. |
...
|-------|----|-------|----------|
| Scrap Drone | 20 | Fast | Floats through the forest and chases when close |
| Rust Bot | 35 | Slow | Sturdy walker that wanders until it spots you |
| Vanguard Bot | 40 | Medium | Agile sentinel found near the eastern river |
| Heavy Mech | 60 | Very Slow | Powerful tank with high health; approach carefully |
